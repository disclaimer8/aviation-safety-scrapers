...
VENDORED = {
    ...
    "beacg": {"http": "httpc", "robots": "robots", "text": "text"},
    "caav": {"http": "httpc", "robots": "robots", "text": "text"},
    "jcaa": {"http": "httpc", "robots": "robots", "text": "text"},
    "nbaai": {"http": "httpc", "robots": "robots", "text": "text"},
    "ttcaa": {"http": "httpc", "robots": "robots", "text": "text"},
    "aaicmv": {"http": "httpc", "robots": "robots", "text": "text"},
    "aet": {"http": "httpc", "robots": "robots", "text": "text"},
    "bdca": {"http": "httpc", "robots": "robots", "text": "text"},
    "mzisi": {"http": "httpc", "robots": "robots", "text": "text"},
    "taiib": {"http": "httpc", "robots": "robots", "text": "text"},
