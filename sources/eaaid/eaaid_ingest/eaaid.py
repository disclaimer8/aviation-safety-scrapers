...
#
# https://www.civilaviation.gov.eg/robots.txt allows Googlebot and Bingbot by
# name and then says, for everyone else:
#     User-agent: *
#     Disallow: /
# We are neither. Checked 2026-09-11.
#
# This package is deployed and running, so it is crawling a site that has
# said no — the same situation as aaicth (Thailand). sources/ enforces
# Disallow, so promoting it would mean breaking that policy or adding a
# second exemption alongside bfu's, and neither was mine to choose.
#
# Note this is a named-agent allowlist, not a blanket ban: the site is
# willing to be crawled, just selectively. That makes asking worthwhile —
# ECAA may simply add an agent, or point at the data directly.
