# aaibmn_ingest/text.py — Mongolian text helpers.
#
# The three shared helpers (strip_html, slugify, make_site_slug) live in
# _textbase.py, vendored from _common/text.py, and are re-exported here so
# every caller keeps importing them from .text. Same shape as nsib and
# aaiahk.
import re
