"""Smoke tests for cins-ingest.

These PARSE the script; they do not import it. cins_ocr_backfill.py runs its ingest at
...
SCRIPT = HERE / "cins_ocr_backfill.py"
...
def test_the_header_still_records_where_the_data_comes_from():
    ...
    lowered = doc.lower()
    assert "cins" in lowered or "http" in lowered, (
