...
# Set explicitly, not derived from MIN_NARRATIVE. The two answer different
# questions: MIN_NARRATIVE is "is this PDF's text layer good enough to use
# instead of OCR", _NARRATIVE_FLOOR is "is this row worth publishing".
# Deriving one from the other meant tuning the OCR threshold silently
# moved this source's publication gate. 300 matches prod's NARRATIVE_MIN
# and the rest of the tree.
_NARRATIVE_FLOOR = 300   # 300 chars as per task
