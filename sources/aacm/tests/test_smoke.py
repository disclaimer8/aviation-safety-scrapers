"""Smoke tests for aacm-ingest.

These PARSE the script; they do not import it. aacm_ingest.py runs its ingest at
...
def test_the_header_still_records_where_the_data_comes_from():
    ...
    lowered = doc.lower()
    assert "aacm" in lowered or "http" in lowered, (
