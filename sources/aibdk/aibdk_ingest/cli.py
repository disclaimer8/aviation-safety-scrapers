...
def _build_argparser():
    ...
    ap.add_argument(
        "--proxy",
        default=os.environ.get("AIBDK_PROXY"),
        help="SOCKS5/HTTP proxy URL (default: $AIBDK_PROXY env var)",
    )
    return ap
