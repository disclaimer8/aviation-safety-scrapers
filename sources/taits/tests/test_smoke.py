"""Smoke tests for taits-ingest.

These PARSE the script; they do not import it. taits_rebuild_pdf.py runs its ingest at
...
SCRIPT = HERE / "taits_rebuild_pdf.py"
...
def test_the_header_still_records_where_the_data_comes_from():
    ...
    lowered = doc.lower()
    assert "taits" in lowered or "http" in lowered, (
