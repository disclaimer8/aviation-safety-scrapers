...
Usage:
    python scripts/enrich_from_header.py --db /path/to/tsb.db [--dry-run]
...
from tsb_ingest.header import parse_header
...
def main():
    ...
    parser.add_argument("--db", help="Path to tsb.db SQLite file")
