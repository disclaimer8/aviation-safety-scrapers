...
set -uo pipefail
cd /home/a1/ttcaa-ingest
. .venv/bin/activate
DB=/home/a1/ttcaa-ingest/ttcaa.db
PDFS=/home/a1/ttcaa-ingest/pdfs
rc=0
...
bash /home/a1/ttcaa-ingest/ttcaa-sync-to-prod.sh "$DB" || echo "[run-cycle] ttcaa-sync failed (non-fatal)"
exit $rc
